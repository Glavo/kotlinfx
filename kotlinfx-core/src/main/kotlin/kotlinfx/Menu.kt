...
typealias ContextMenu = javafx.scene.control.ContextMenu

typealias MenuButton = javafx.scene.control.MenuButton
typealias SplitMenuButton = javafx.scene.control.SplitMenuButton

typealias MenuItem = javafx.scene.control.MenuItem
typealias CustomMenuItem = javafx.scene.control.CustomMenuItem
typealias CheckMenuItem = javafx.scene.control.CheckMenuItem
typealias SeparatorMenuItem = javafx.scene.control.SeparatorMenuItem
typealias RadioMenuItem = javafx.scene.control.RadioMenuItem
