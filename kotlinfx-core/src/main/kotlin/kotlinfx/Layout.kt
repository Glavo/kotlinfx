...
typealias AnchorPane = javafx.scene.layout.AnchorPane
typealias BorderPane = javafx.scene.layout.BorderPane
typealias FlowPane = javafx.scene.layout.FlowPane
typealias GridPane = javafx.scene.layout.GridPane
typealias HBox = javafx.scene.layout.HBox
typealias VBox = javafx.scene.layout.VBox
typealias StackPane = javafx.scene.layout.StackPane
typealias TilePane = javafx.scene.layout.TilePane

typealias Priority = javafx.scene.layout.Priority

typealias Region = javafx.scene.layout.Region

typealias Background = javafx.scene.layout.Background
typealias BackgroundFill = javafx.scene.layout.BackgroundFill
typealias BackgroundImage = javafx.scene.layout.BackgroundImage
typealias BackgroundPosition = javafx.scene.layout.BackgroundPosition
typealias BackgroundRepeat = javafx.scene.layout.BackgroundRepeat
typealias BackgroundSize = javafx.scene.layout.BackgroundSize

typealias Border = javafx.scene.layout.Border
typealias BorderImage = javafx.scene.layout.BorderImage
typealias BorderRepeat = javafx.scene.layout.BorderRepeat
typealias BorderStroke = javafx.scene.layout.BorderStroke
typealias BorderStrokeStyle = javafx.scene.layout.BorderStrokeStyle
typealias BorderWidths = javafx.scene.layout.BorderWidths

typealias ConstraintsBase = javafx.scene.layout.ConstraintsBase
typealias ColumnConstraints = javafx.scene.layout.ColumnConstraints
typealias RowConstraints = javafx.scene.layout.RowConstraints

typealias CornerRadii = javafx.scene.layout.CornerRadii
...
inline fun borderPane(
    ...
    return BorderPane().apply(initializer)
}
...
inline fun flowPane(vararg children: Node, orientation: Orientation = Orientation.HORIZONTAL, initializer: FlowPane.() -> Unit = {}): FlowPane {
    return FlowPane(orientation, *children).apply(initializer)
}

@JvmName("flowPaneOfArray")
inline fun flowPane(children: Array<out Node>, orientation: Orientation = Orientation.HORIZONTAL, initializer: FlowPane.() -> Unit = {}): FlowPane {
    return FlowPane(orientation, *children).apply(initializer)
}

inline fun flowPane(children: Collection<Node>, orientation: Orientation = Orientation.HORIZONTAL, initializer: FlowPane.() -> Unit = {}): FlowPane {
